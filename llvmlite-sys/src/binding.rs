...
impl Display for LoadError {
    fn fmt(&self, f: &mut Formatter<'_>) -> std::fmt::Result {
        match self {
            LoadError::LoadFunction { target, inner } => write!(f, "LoadError(function={target:?}, error={inner})"),
...
pub struct LLVMMethods<'lib> {
    set_cmd_line: Symbol<'lib, LLVMPY_SetCommandLine>,
    parse_assembly: Symbol<'lib, LLVMPY_ParseAssembly>,
    write_bitcode_to_string: Symbol<'lib, LLVMPY_WriteBitcodeToString>,
    parse_bitcode: Symbol<'lib, LLVMPY_ParseBitcode>,
    create_string: Symbol<'lib, LLVMPY_CreateString>,
    create_byte_string: Symbol<'lib, LLVMPY_CreateByteString>,
    dispose_string: Symbol<'lib, LLVMPY_DisposeString>,
    get_global_context: Symbol<'lib, LLVMPY_GetGlobalContext>,
    context_create: Symbol<'lib, LLVMPY_ContextCreate>,
    context_dispose: Symbol<'lib, LLVMPY_ContextDispose>,
    add_ref_prune_pass: Symbol<'lib, LLVMPY_AddRefPrunePass>,
    dump_ref_prune_stats: Symbol<'lib, LLVMPY_DumpRefPruneStats>,
    search_address_of_symbol: Symbol<'lib, LLVMPY_SearchAddressOfSymbol>,
    add_symbol: Symbol<'lib, LLVMPY_AddSymbol>,
    load_library_permanently: Symbol<'lib, LLVMPY_LoadLibraryPermanently>,
    link_in_mc_jit: Symbol<'lib, LLVMPY_LinkInMCJIT>,
    dispose_execution_engine: Symbol<'lib, LLVMPY_DisposeExecutionEngine>,
    add_module: Symbol<'lib, LLVMPY_AddModule>,
    remove_module: Symbol<'lib, LLVMPY_RemoveModule>,
    finalize_object: Symbol<'lib, LLVMPY_FinalizeObject>,
    create_mc_jit_compiler: Symbol<'lib, LLVMPY_CreateMCJITCompiler>,
    get_global_value_address: Symbol<'lib, LLVMPY_GetGlobalValueAddress>,
    get_function_address: Symbol<'lib, LLVMPY_GetFunctionAddress>,
    run_static_constructors: Symbol<'lib, LLVMPY_RunStaticConstructors>,
    run_static_destructors: Symbol<'lib, LLVMPY_RunStaticDestructors>,
    add_global_mapping: Symbol<'lib, LLVMPY_AddGlobalMapping>,
    get_execution_engine_target_data: Symbol<'lib, LLVMPY_GetExecutionEngineTargetData>,
    try_allocate_executable_memory: Symbol<'lib, LLVMPY_TryAllocateExecutableMemory>,
    enable_jit_events: Symbol<'lib, LLVMPY_EnableJITEvents>,
    mc_jit_add_object_file: Symbol<'lib, LLVMPY_MCJITAddObjectFile>,
    create_object_cache: Symbol<'lib, LLVMPY_CreateObjectCache>,
    dispose_object_cache: Symbol<'lib, LLVMPY_DisposeObjectCache>,
    set_object_cache: Symbol<'lib, LLVMPY_SetObjectCache>,
    shutdown: Symbol<'lib, LLVMPY_Shutdown>,
    get_version_info: Symbol<'lib, LLVMPY_GetVersionInfo>,
    link_modules: Symbol<'lib, LLVMPY_LinkModules>,
    dispose_module: Symbol<'lib, LLVMPY_DisposeModule>,
    print_module_to_string: Symbol<'lib, LLVMPY_PrintModuleToString>,
    get_module_source_file_name: Symbol<'lib, LLVMPY_GetModuleSourceFileName>,
    get_module_name: Symbol<'lib, LLVMPY_GetModuleName>,
    set_module_name: Symbol<'lib, LLVMPY_SetModuleName>,
    get_named_function: Symbol<'lib, LLVMPY_GetNamedFunction>,
    get_named_global_variable: Symbol<'lib, LLVMPY_GetNamedGlobalVariable>,
    get_named_struct_type: Symbol<'lib, LLVMPY_GetNamedStructType>,
    verify_module: Symbol<'lib, LLVMPY_VerifyModule>,
    get_data_layout: Symbol<'lib, LLVMPY_GetDataLayout>,
    set_data_layout: Symbol<'lib, LLVMPY_SetDataLayout>,
    get_target: Symbol<'lib, LLVMPY_GetTarget>,
    set_target: Symbol<'lib, LLVMPY_SetTarget>,
    module_globals_iter: Symbol<'lib, LLVMPY_ModuleGlobalsIter>,
    module_functions_iter: Symbol<'lib, LLVMPY_ModuleFunctionsIter>,
    module_types_iter: Symbol<'lib, LLVMPY_ModuleTypesIter>,
    globals_iter_next: Symbol<'lib, LLVMPY_GlobalsIterNext>,
    functions_iter_next: Symbol<'lib, LLVMPY_FunctionsIterNext>,
    types_iter_next: Symbol<'lib, LLVMPY_TypesIterNext>,
    dispose_globals_iter: Symbol<'lib, LLVMPY_DisposeGlobalsIter>,
    dispose_functions_iter: Symbol<'lib, LLVMPY_DisposeFunctionsIter>,
    dispose_types_iter: Symbol<'lib, LLVMPY_DisposeTypesIter>,
    clone_module: Symbol<'lib, LLVMPY_CloneModule>,
    create_object_file: Symbol<'lib, LLVMPY_CreateObjectFile>,
    dispose_object_file: Symbol<'lib, LLVMPY_DisposeObjectFile>,
    get_sections: Symbol<'lib, LLVMPY_GetSections>,
    dispose_section_iterator: Symbol<'lib, LLVMPY_DisposeSectionIterator>,
    move_to_next_section: Symbol<'lib, LLVMPY_MoveToNextSection>,
    is_section_iterator_at_end: Symbol<'lib, LLVMPY_IsSectionIteratorAtEnd>,
    get_section_name: Symbol<'lib, LLVMPY_GetSectionName>,
    get_section_address: Symbol<'lib, LLVMPY_GetSectionAddress>,
    get_section_contents: Symbol<'lib, LLVMPY_GetSectionContents>,
    get_section_size: Symbol<'lib, LLVMPY_GetSectionSize>,
    is_section_text: Symbol<'lib, LLVMPY_IsSectionText>,
    set_time_passes: Symbol<'lib, LLVMPY_SetTimePasses>,
    report_and_reset_timings: Symbol<'lib, LLVMPY_ReportAndResetTimings>,
    create_pass_manager: Symbol<'lib, LLVMPY_CreatePassManager>,
    dispose_pass_manager: Symbol<'lib, LLVMPY_DisposePassManager>,
    create_function_pass_manager: Symbol<'lib, LLVMPY_CreateFunctionPassManager>,
    run_pass_manager_with_remarks: Symbol<'lib, LLVMPY_RunPassManagerWithRemarks>,
    run_pass_manager: Symbol<'lib, LLVMPY_RunPassManager>,
    run_function_pass_manager_with_remarks: Symbol<'lib, LLVMPY_RunFunctionPassManagerWithRemarks>,
    run_function_pass_manager: Symbol<'lib, LLVMPY_RunFunctionPassManager>,
    initialize_function_pass_manager: Symbol<'lib, LLVMPY_InitializeFunctionPassManager>,
    finalize_function_pass_manager: Symbol<'lib, LLVMPY_FinalizeFunctionPassManager>,
    add_a_a_eval_pass: Symbol<'lib, LLVMPY_AddAAEvalPass>,
    add_basic_a_a_wrapper_pass: Symbol<'lib, LLVMPY_AddBasicAAWrapperPass>,
    add_dependence_analysis_pass: Symbol<'lib, LLVMPY_AddDependenceAnalysisPass>,
    add_call_graph_dot_printer_pass: Symbol<'lib, LLVMPY_AddCallGraphDOTPrinterPass>,
    add_dot_dom_printer_pass: Symbol<'lib, LLVMPY_AddDotDomPrinterPass>,
    add_globals_mod_ref_a_a_pass: Symbol<'lib, LLVMPY_AddGlobalsModRefAAPass>,
    add_dot_post_dom_printer_pass: Symbol<'lib, LLVMPY_AddDotPostDomPrinterPass>,
    add_cfg_printer_pass: Symbol<'lib, LLVMPY_AddCFGPrinterPass>,
    add_constant_merge_pass: Symbol<'lib, LLVMPY_AddConstantMergePass>,
    add_dead_store_elimination_pass: Symbol<'lib, LLVMPY_AddDeadStoreEliminationPass>,
    add_reverse_post_order_function_attrs_pass: Symbol<'lib, LLVMPY_AddReversePostOrderFunctionAttrsPass>,
    add_dead_arg_elimination_pass: Symbol<'lib, LLVMPY_AddDeadArgEliminationPass>,
    add_instruction_count_pass: Symbol<'lib, LLVMPY_AddInstructionCountPass>,
    add_iv_users_pass: Symbol<'lib, LLVMPY_AddIVUsersPass>,
    add_lazy_value_info_pass: Symbol<'lib, LLVMPY_AddLazyValueInfoPass>,
    add_lint_pass: Symbol<'lib, LLVMPY_AddLintPass>,
    add_module_debug_info_printer_pass: Symbol<'lib, LLVMPY_AddModuleDebugInfoPrinterPass>,
    add_region_info_pass: Symbol<'lib, LLVMPY_AddRegionInfoPass>,
    add_scalar_evolution_a_a_pass: Symbol<'lib, LLVMPY_AddScalarEvolutionAAPass>,
    add_aggressive_d_c_e_pass: Symbol<'lib, LLVMPY_AddAggressiveDCEPass>,
    add_always_inliner_pass: Symbol<'lib, LLVMPY_AddAlwaysInlinerPass>,
    add_arg_promotion_pass: Symbol<'lib, LLVMPY_AddArgPromotionPass>,
    add_break_critical_edges_pass: Symbol<'lib, LLVMPY_AddBreakCriticalEdgesPass>,
    add_function_attrs_pass: Symbol<'lib, LLVMPY_AddFunctionAttrsPass>,
    add_function_inlining_pass: Symbol<'lib, LLVMPY_AddFunctionInliningPass>,
    add_global_optimizer_pass: Symbol<'lib, LLVMPY_AddGlobalOptimizerPass>,
    add_global_dce_pass: Symbol<'lib, LLVMPY_AddGlobalDCEPass>,
    add_ipsccp_pass: Symbol<'lib, LLVMPY_AddIPSCCPPass>,
    add_dead_code_elimination_pass: Symbol<'lib, LLVMPY_AddDeadCodeEliminationPass>,
    add_aggressive_instruction_combining_pass: Symbol<'lib, LLVMPY_AddAggressiveInstructionCombiningPass>,
    add_internalize_pass: Symbol<'lib, LLVMPY_AddInternalizePass>,
    add_jump_threading_pass: Symbol<'lib, LLVMPY_AddJumpThreadingPass>,
    add_lcssa_pass: Symbol<'lib, LLVMPY_AddLCSSAPass>,
    add_loop_deletion_pass: Symbol<'lib, LLVMPY_AddLoopDeletionPass>,
    add_single_loop_extractor_pass: Symbol<'lib, LLVMPY_AddSingleLoopExtractorPass>,
    add_loop_strength_reduce_pass: Symbol<'lib, LLVMPY_AddLoopStrengthReducePass>,
    add_loop_simplification_pass: Symbol<'lib, LLVMPY_AddLoopSimplificationPass>,
    add_loop_unroll_pass: Symbol<'lib, LLVMPY_AddLoopUnrollPass>,
    add_loop_unroll_and_jam_pass: Symbol<'lib, LLVMPY_AddLoopUnrollAndJamPass>,
    add_loop_unswitch_pass: Symbol<'lib, LLVMPY_AddLoopUnswitchPass>,
    add_lower_atomic_pass: Symbol<'lib, LLVMPY_AddLowerAtomicPass>,
    add_lower_invoke_pass: Symbol<'lib, LLVMPY_AddLowerInvokePass>,
    add_lower_switch_pass: Symbol<'lib, LLVMPY_AddLowerSwitchPass>,
    add_mem_cpy_optimization_pass: Symbol<'lib, LLVMPY_AddMemCpyOptimizationPass>,
    add_merge_functions_pass: Symbol<'lib, LLVMPY_AddMergeFunctionsPass>,
    add_merge_returns_pass: Symbol<'lib, LLVMPY_AddMergeReturnsPass>,
    add_partial_inlining_pass: Symbol<'lib, LLVMPY_AddPartialInliningPass>,
    add_prune_exception_handling_pass: Symbol<'lib, LLVMPY_AddPruneExceptionHandlingPass>,
    add_re_associate_pass: Symbol<'lib, LLVMPY_AddReassociatePass>,
    add_demote_register_to_memory_pass: Symbol<'lib, LLVMPY_AddDemoteRegisterToMemoryPass>,
    add_sink_pass: Symbol<'lib, LLVMPY_AddSinkPass>,
    add_strip_symbols_pass: Symbol<'lib, LLVMPY_AddStripSymbolsPass>,
    add_strip_dead_debug_info_pass: Symbol<'lib, LLVMPY_AddStripDeadDebugInfoPass>,
    add_strip_dead_prototypes_pass: Symbol<'lib, LLVMPY_AddStripDeadPrototypesPass>,
    add_strip_debug_declare_prototypes_pass: Symbol<'lib, LLVMPY_AddStripDebugDeclarePrototypesPass>,
    add_strip_nondebug_symbols_pass: Symbol<'lib, LLVMPY_AddStripNondebugSymbolsPass>,
    add_tail_call_elimination_pass: Symbol<'lib, LLVMPY_AddTailCallEliminationPass>,
    add_cfg_simplification_pass: Symbol<'lib, LLVMPY_AddCFGSimplificationPass>,
    add_gvn_pass: Symbol<'lib, LLVMPY_AddGVNPass>,
    add_instruction_combining_pass: Symbol<'lib, LLVMPY_AddInstructionCombiningPass>,
    add_licm_pass: Symbol<'lib, LLVMPY_AddLICMPass>,
    add_sccp_pass: Symbol<'lib, LLVMPY_AddSCCPPass>,
    add_sroa_pass: Symbol<'lib, LLVMPY_AddSROAPass>,
    add_type_based_alias_analysis_pass: Symbol<'lib, LLVMPY_AddTypeBasedAliasAnalysisPass>,
    add_basic_alias_analysis_pass: Symbol<'lib, LLVMPY_AddBasicAliasAnalysisPass>,
    llvm_add_loop_rotate_pass: Symbol<'lib, LLVMPY_LLVMAddLoopRotatePass>,
    get_process_triple: Symbol<'lib, LLVMPY_GetProcessTriple>,
    get_host_c_p_u_features: Symbol<'lib, LLVMPY_GetHostCPUFeatures>,
    get_default_target_triple: Symbol<'lib, LLVMPY_GetDefaultTargetTriple>,
    get_host_c_p_u_name: Symbol<'lib, LLVMPY_GetHostCPUName>,
    get_triple_object_format: Symbol<'lib, LLVMPY_GetTripleObjectFormat>,
    create_target_data: Symbol<'lib, LLVMPY_CreateTargetData>,
    copy_string_rep_of_target_data: Symbol<'lib, LLVMPY_CopyStringRepOfTargetData>,
    dispose_target_data: Symbol<'lib, LLVMPY_DisposeTargetData>,
    abi_size_of_type: Symbol<'lib, LLVMPY_ABISizeOfType>,
    offset_of_element: Symbol<'lib, LLVMPY_OffsetOfElement>,
    abi_size_of_element_type: Symbol<'lib, LLVMPY_ABISizeOfElementType>,
    abi_alignment_of_element_type: Symbol<'lib, LLVMPY_ABIAlignmentOfElementType>,
    get_target_from_triple: Symbol<'lib, LLVMPY_GetTargetFromTriple>,
    get_target_name: Symbol<'lib, LLVMPY_GetTargetName>,
    get_target_description: Symbol<'lib, LLVMPY_GetTargetDescription>,
    create_target_machine: Symbol<'lib, LLVMPY_CreateTargetMachine>,
    dispose_target_machine: Symbol<'lib, LLVMPY_DisposeTargetMachine>,
    get_target_machine_triple: Symbol<'lib, LLVMPY_GetTargetMachineTriple>,
    set_target_machine_asm_verbosity: Symbol<'lib, LLVMPY_SetTargetMachineAsmVerbosity>,
    target_machine_emit_to_memory: Symbol<'lib, LLVMPY_TargetMachineEmitToMemory>,
    create_target_machine_data: Symbol<'lib, LLVMPY_CreateTargetMachineData>,
    add_analysis_passes: Symbol<'lib, LLVMPY_AddAnalysisPasses>,
    get_buffer_start: Symbol<'lib, LLVMPY_GetBufferStart>,
    get_buffer_size: Symbol<'lib, LLVMPY_GetBufferSize>,
    dispose_memory_buffer: Symbol<'lib, LLVMPY_DisposeMemoryBuffer>,
    has_svml_support: Symbol<'lib, LLVMPY_HasSVMLSupport>,
    pass_manager_builder_create: Symbol<'lib, LLVMPY_PassManagerBuilderCreate>,
    pass_manager_builder_dispose: Symbol<'lib, LLVMPY_PassManagerBuilderDispose>,
    pass_manager_builder_get_opt_level: Symbol<'lib, LLVMPY_PassManagerBuilderGetOptLevel>,
    pass_manager_builder_set_opt_level: Symbol<'lib, LLVMPY_PassManagerBuilderSetOptLevel>,
    pass_manager_builder_get_size_level: Symbol<'lib, LLVMPY_PassManagerBuilderGetSizeLevel>,
    pass_manager_builder_set_size_level: Symbol<'lib, LLVMPY_PassManagerBuilderSetSizeLevel>,
    pass_manager_builder_get_disable_unroll_loops: Symbol<'lib, LLVMPY_PassManagerBuilderGetDisableUnrollLoops>,
    pass_manager_builder_set_disable_unroll_loops: Symbol<'lib, LLVMPY_PassManagerBuilderSetDisableUnrollLoops>,
    pass_manager_builder_use_inliner_with_threshold: Symbol<'lib, LLVMPY_PassManagerBuilderUseInlinerWithThreshold>,
    pass_manager_builder_populate_function_pass_manager: Symbol<'lib, LLVMPY_PassManagerBuilderPopulateFunctionPassManager>,
    pass_manager_builder_set_loop_vectorize: Symbol<'lib, LLVMPY_PassManagerBuilderSetLoopVectorize>,
    pass_manager_builder_get_loop_vectorize: Symbol<'lib, LLVMPY_PassManagerBuilderGetLoopVectorize>,
    pass_manager_builder_set_s_l_p_vectorize: Symbol<'lib, LLVMPY_PassManagerBuilderSetSLPVectorize>,
    pass_manager_builder_get_s_l_p_vectorize: Symbol<'lib, LLVMPY_PassManagerBuilderGetSLPVectorize>,
    function_attributes_iter: Symbol<'lib, LLVMPY_FunctionAttributesIter>,
    argument_attributes_iter: Symbol<'lib, LLVMPY_ArgumentAttributesIter>,
    call_inst_attributes_iter: Symbol<'lib, LLVMPY_CallInstAttributesIter>,
    invoke_inst_attributes_iter: Symbol<'lib, LLVMPY_InvokeInstAttributesIter>,
    global_attributes_iter: Symbol<'lib, LLVMPY_GlobalAttributesIter>,
    function_blocks_iter: Symbol<'lib, LLVMPY_FunctionBlocksIter>,
    function_arguments_iter: Symbol<'lib, LLVMPY_FunctionArgumentsIter>,
    block_instructions_iter: Symbol<'lib, LLVMPY_BlockInstructionsIter>,
    instruction_operands_iter: Symbol<'lib, LLVMPY_InstructionOperandsIter>,
    attribute_list_iter_next: Symbol<'lib, LLVMPY_AttributeListIterNext>,
    blocks_iter_next: Symbol<'lib, LLVMPY_BlocksIterNext>,
    arguments_iter_next: Symbol<'lib, LLVMPY_ArgumentsIterNext>,
    instructions_iter_next: Symbol<'lib, LLVMPY_InstructionsIterNext>,
    operands_iter_next: Symbol<'lib, LLVMPY_OperandsIterNext>,
    dispose_attribute_list_iter: Symbol<'lib, LLVMPY_DisposeAttributeListIter>,
    dispose_attribute_set_iter: Symbol<'lib, LLVMPY_DisposeAttributeSetIter>,
    dispose_blocks_iter: Symbol<'lib, LLVMPY_DisposeBlocksIter>,
    dispose_arguments_iter: Symbol<'lib, LLVMPY_DisposeArgumentsIter>,
    dispose_instructions_iter: Symbol<'lib, LLVMPY_DisposeInstructionsIter>,
    dispose_operands_iter: Symbol<'lib, LLVMPY_DisposeOperandsIter>,
    print_value_to_string: Symbol<'lib, LLVMPY_PrintValueToString>,
    get_value_name: Symbol<'lib, LLVMPY_GetValueName>,
    set_value_name: Symbol<'lib, LLVMPY_SetValueName>,
    get_global_parent: Symbol<'lib, LLVMPY_GetGlobalParent>,
    type_of: Symbol<'lib, LLVMPY_TypeOf>,
    print_type: Symbol<'lib, LLVMPY_PrintType>,
    get_type_name: Symbol<'lib, LLVMPY_GetTypeName>,
    type_is_pointer: Symbol<'lib, LLVMPY_TypeIsPointer>,
    get_element_type: Symbol<'lib, LLVMPY_GetElementType>,
    set_linkage: Symbol<'lib, LLVMPY_SetLinkage>,
    get_linkage: Symbol<'lib, LLVMPY_GetLinkage>,
    set_visibility: Symbol<'lib, LLVMPY_SetVisibility>,
    get_visibility: Symbol<'lib, LLVMPY_GetVisibility>,
    set_dll_storage_class: Symbol<'lib, LLVMPY_SetDLLStorageClass>,
    get_dll_storage_class: Symbol<'lib, LLVMPY_GetDLLStorageClass>,
    get_enum_attribute_kind_for_name: Symbol<'lib, LLVMPY_GetEnumAttributeKindForName>,
    add_function_attr: Symbol<'lib, LLVMPY_AddFunctionAttr>,
    is_declaration: Symbol<'lib, LLVMPY_IsDeclaration>,
    write_cfg: Symbol<'lib, LLVMPY_WriteCFG>,
    get_opcode_name: Symbol<'lib, LLVMPY_GetOpcodeName>,
}
...
mod tests {
    ...
    #[test]
    fn test_load() {
        let lib = unsafe { LLVMLite::new("bin/llvmlite") }.unwrap();
        println!("Success!");
    }
}